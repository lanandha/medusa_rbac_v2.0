...
export declare class WrappedEntity<Entity extends object> {
    ...
    get __platform(): import("@mikro-orm/core").Platform;
    get __config(): import("@mikro-orm/core").Configuration<import("../drivers/IDatabaseDriver").IDatabaseDriver<import("@mikro-orm/core").Connection>, EntityManager<import("../drivers/IDatabaseDriver").IDatabaseDriver<import("@mikro-orm/core").Connection>>>;
