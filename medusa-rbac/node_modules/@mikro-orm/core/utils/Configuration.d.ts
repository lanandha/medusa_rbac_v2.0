...
export declare class Configuration<D extends IDatabaseDriver = IDatabaseDriver, EM extends EntityManager = D[typeof EntityManagerType] & EntityManager> {
    static readonly DEFAULTS: {
        ...
        context: (name: string) => EntityManager<IDatabaseDriver<import("@mikro-orm/core").Connection>> | undefined;
        contextName: string;
 ...
 */
export declare function defineConfig<D extends IDatabaseDriver>(options: Options<D>): Options<D, D[typeof EntityManagerType] & EntityManager<IDatabaseDriver<import("@mikro-orm/core").Connection>>>;
