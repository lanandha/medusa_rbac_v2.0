import { FindConfig } from "@medusajs/types/src/common";
import { RestoreReturn, SoftDeleteReturn } from "@medusajs/types/src/dal";
import { IModuleService } from "@medusajs/types/src/modules-sdk";
import { Context } from "@medusajs/types/src/shared-context";
import { AddPriceListPricesDTO, AddPricesDTO, CalculatedPriceSet, CreatePriceListDTO, CreatePriceRuleDTO, CreatePriceSetDTO, FilterablePriceListProps, FilterablePriceListRuleProps, FilterablePriceProps, FilterablePriceRuleProps, FilterablePriceSetProps, PriceDTO, PriceListDTO, PriceListRuleDTO, PriceRuleDTO, PriceSetDTO, PricingContext, PricingFilters, RemovePriceListRulesDTO, SetPriceListRulesDTO, UpdatePriceListDTO, UpdatePriceListPricesDTO, UpdatePriceRuleDTO, UpdatePriceSetDTO, UpsertPriceSetDTO } from "@medusajs/types/src/pricing/common";
import { CreatePricePreferenceDTO, FilterablePricePreferenceProps, PricePreferenceDTO, UpdatePricePreferenceDTO, UpsertPricePreferenceDTO } from "@medusajs/types/src/pricing/common/price-preference";
/**
...
export interface IPricingModuleService extends IModuleService {
     ...
     * ```
     */
    retrievePriceSet(id: string, config?: FindConfig<PriceSetDTO>, sharedContext?: Context): Promise<PriceSetDTO>;
    /**
     ...
     * ```
     */
    listPriceSets(filters?: FilterablePriceSetProps, config?: FindConfig<PriceSetDTO>, sharedContext?: Context): Promise<PriceSetDTO[]>;
    /**
     ...
     * ```
     */
    listAndCountPriceSets(filters?: FilterablePriceSetProps, config?: FindConfig<PriceSetDTO>, sharedContext?: Context): Promise<[PriceSetDTO[], number]>;
    /**
     ...
     * ```
     */
    createPriceSets(data: CreatePriceSetDTO, sharedContext?: Context): Promise<PriceSetDTO>;
    /**
     ...
     * )
     */
    updatePriceSets(id: string, data: UpdatePriceSetDTO, sharedContext?: Context): Promise<PriceSetDTO>;
    /**
     ...
     * )
     */
    updatePriceSets(selector: FilterablePriceSetProps, data: UpdatePriceSetDTO, sharedContext?: Context): Promise<PriceSetDTO[]>;
    /**
     ...
     * ```
     */
    retrievePricePreference(id: string, config?: FindConfig<PricePreferenceDTO>, sharedContext?: Context): Promise<PricePreferenceDTO>;
    /**
     ...
     * ```
     */
    listPricePreferences(filters?: FilterablePricePreferenceProps, config?: FindConfig<PricePreferenceDTO>, sharedContext?: Context): Promise<PricePreferenceDTO[]>;
    /**
     ...
     * ```
     */
    createPricePreferences(data: CreatePricePreferenceDTO, sharedContext?: Context): Promise<PricePreferenceDTO>;
    /**
     ...
     * )
     */
    updatePricePreferences(id: string, data: UpdatePricePreferenceDTO, sharedContext?: Context): Promise<PricePreferenceDTO>;
    /**
     ...
     * )
     */
    updatePricePreferences(selector: FilterablePricePreferenceProps, data: UpdatePricePreferenceDTO, sharedContext?: Context): Promise<PricePreferenceDTO[]>;
    /**
     ...
     * ])
     */
    softDeletePricePreferences<TReturnableLinkableKeys extends string = string>(pricePreferenceIds: string[], config?: SoftDeleteReturn<TReturnableLinkableKeys>, sharedContext?: Context): Promise<Record<string, string[]> | void>;
    /**
     ...
     * ])
     */
    restorePricePreferences<TReturnableLinkableKeys extends string = string>(pricePreferenceIds: string[], config?: RestoreReturn<TReturnableLinkableKeys>, sharedContext?: Context): Promise<Record<string, string[]> | void>;
    /**
