import { CreateInviteDTO, CreateUserDTO, UpdateInviteDTO, UpdateUserDTO } from "@medusajs/types/src/user/mutations";
import { FilterableUserProps, InviteDTO, UserDTO } from "@medusajs/types/src/user/common";
...
export interface IUserModuleService extends IModuleService {
     ...
     * ```
     */
    listAndCountUsers(filters?: FilterableUserProps, config?: FindConfig<UserDTO>, sharedContext?: Context): Promise<[UserDTO[], number]>;
    /**
     ...
     * ])
     */
    softDeleteUsers<TReturnableLinkableKeys extends string = string>(userIds: string[], config?: SoftDeleteReturn<TReturnableLinkableKeys>, sharedContext?: Context): Promise<Record<TReturnableLinkableKeys, string[]> | void>;
    /**
     ...
     * ])
     */
    restoreUsers<TReturnableLinkableKeys extends string = string>(userIds: string[], config?: RestoreReturn<TReturnableLinkableKeys>, sharedContext?: Context): Promise<Record<TReturnableLinkableKeys, string[]> | void>;
    /**
