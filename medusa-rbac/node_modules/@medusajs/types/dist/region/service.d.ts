...
import { FilterableRegionCountryProps, FilterableRegionProps, RegionCountryDTO, RegionDTO } from "@medusajs/types/src/region/common";
import { CreateRegionDTO, UpdateRegionDTO, UpsertRegionDTO } from "@medusajs/types/src/region/mutations";
/**
...
export interface IRegionModuleService extends IModuleService {
     ...
     * })
     */
    softDeleteRegions<TReturnableLinkableKeys extends string = string>(regionIds: string[], config?: SoftDeleteReturn<TReturnableLinkableKeys>, sharedContext?: Context): Promise<Record<string, string[]> | void>;
    /**
     ...
     * })
     */
    restoreRegions<TReturnableLinkableKeys extends string = string>(regionIds: string[], config?: RestoreReturn<TReturnableLinkableKeys>, sharedContext?: Context): Promise<Record<string, string[]> | void>;
}
