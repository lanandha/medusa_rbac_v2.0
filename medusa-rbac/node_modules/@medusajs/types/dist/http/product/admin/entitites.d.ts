import { AdminCollection } from "@medusajs/types/src/http/collection";
import { AdminInventoryItem } from "@medusajs/types/src/http/inventory";
import { AdminPrice } from "@medusajs/types/src/http/pricing";
import { AdminProductCategory } from "@medusajs/types/src/http/product-category";
import { AdminProductTag } from "@medusajs/types/src/http/product-tag";
import { AdminProductType } from "@medusajs/types/src/http/product-type";
import { AdminSalesChannel } from "@medusajs/types/src/http/sales-channel";
import { AdminShippingProfile } from "@medusajs/types/src/http/shipping-profile";
import { BaseProduct, BaseProductImage, BaseProductOption, BaseProductOptionValue, BaseProductVariant, ProductStatus } from "@medusajs/types/src/http/product/common";
