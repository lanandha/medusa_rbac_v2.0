import { BatchResponse, DeleteResponse, DeleteResponseWithParent, PaginatedResponse } from "@medusajs/types/src/http/common";
import { AdminProduct, AdminProductOption, AdminProductVariant, AdminProductVariantInventoryLink } from "@medusajs/types/src/http/product/admin/entitites";
...
export interface AdminImportProductsResponse extends AdminImportProductResponse {
}
