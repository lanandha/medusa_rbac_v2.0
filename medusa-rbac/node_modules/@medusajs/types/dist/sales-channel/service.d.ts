...
import { FilterableSalesChannelProps, SalesChannelDTO } from "@medusajs/types/src/sales-channel/common";
import { CreateSalesChannelDTO, UpdateSalesChannelDTO, UpsertSalesChannelDTO } from "@medusajs/types/src/sales-channel/mutations";
/**
...
export interface ISalesChannelModuleService extends IModuleService {
     ...
     * )
     */
    updateSalesChannels(channelId: string, data: UpdateSalesChannelDTO, sharedContext?: Context): Promise<SalesChannelDTO>;
    /**
     ...
     */
    softDeleteSalesChannels<TReturnableLinkableKeys extends string = string>(salesChannelIds: string[], config?: SoftDeleteReturn<TReturnableLinkableKeys>, sharedContext?: Context): Promise<Record<string, string[]> | void>;
    /**
     ...
     */
    restoreSalesChannels<TReturnableLinkableKeys extends string = string>(salesChannelIds: string[], config?: RestoreReturn<TReturnableLinkableKeys>, sharedContext?: Context): Promise<Record<string, string[]> | void>;
}
