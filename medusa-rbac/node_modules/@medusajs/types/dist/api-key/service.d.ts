...
import { ApiKeyDTO, FilterableApiKeyProps } from "@medusajs/types/src/api-key/common";
import { FindConfig } from "@medusajs/types/src/common";
import { Context } from "@medusajs/types/src/shared-context";
import { CreateApiKeyDTO, RevokeApiKeyDTO, UpdateApiKeyDTO, UpsertApiKeyDTO } from "@medusajs/types/src/api-key/mutations";
/**
...
export interface IApiKeyModuleService extends IModuleService {
     ...
     * }])
     */
    createApiKeys(data: CreateApiKeyDTO[], sharedContext?: Context): Promise<ApiKeyDTO[]>;
    /**
     ...
     * ])
     */
    upsertApiKeys(data: UpsertApiKeyDTO[], sharedContext?: Context): Promise<ApiKeyDTO[]>;
    /**
     ...
     * })
     */
    updateApiKeys(id: string, data: UpdateApiKeyDTO, sharedContext?: Context): Promise<ApiKeyDTO>;
    /**
     ...
     * )
     */
    updateApiKeys(selector: FilterableApiKeyProps, data: UpdateApiKeyDTO, sharedContext?: Context): Promise<ApiKeyDTO[]>;
    /**
     ...
     */
    retrieveApiKey(id: string, config?: FindConfig<ApiKeyDTO>, sharedContext?: Context): Promise<ApiKeyDTO>;
    /**
     ...
     * ```
     */
    listApiKeys(filters?: FilterableApiKeyProps, config?: FindConfig<ApiKeyDTO>, sharedContext?: Context): Promise<ApiKeyDTO[]>;
    /**
     ...
     * ```
     */
    listAndCountApiKeys(filters?: FilterableApiKeyProps, config?: FindConfig<ApiKeyDTO>, sharedContext?: Context): Promise<[ApiKeyDTO[], number]>;
    /**
