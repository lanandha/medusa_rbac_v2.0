import { CreateCityGeoZoneDTO, CreateCountryGeoZoneDTO, CreateProvinceGeoZoneDTO, CreateZipGeoZoneDTO, UpdateCityGeoZoneDTO, UpdateCountryGeoZoneDTO, UpdateProvinceGeoZoneDTO, UpdateZipGeoZoneDTO } from "@medusajs/types/src/fulfillment/mutations/geo-zone";
/**
...
export interface UpdateServiceZoneDTO {
     ...
     * The geo zones associated with the service zone.
     */
    geo_zones?: (Omit<CreateCountryGeoZoneDTO, "service_zone_id"> | Omit<CreateProvinceGeoZoneDTO, "service_zone_id"> | Omit<CreateCityGeoZoneDTO, "service_zone_id"> | Omit<CreateZipGeoZoneDTO, "service_zone_id"> | UpdateCountryGeoZoneDTO | UpdateProvinceGeoZoneDTO | UpdateCityGeoZoneDTO | UpdateZipGeoZoneDTO | {
        /**
