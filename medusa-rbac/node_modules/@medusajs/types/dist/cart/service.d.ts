...
export interface ICartModuleService extends IModuleService {
     ...
     * ])
     */
    updateLineItems(data: UpdateLineItemWithoutSelectorDTO[]): Promise<CartLineItemDTO[]>;
    /**
     ...
     *
     */
    upsertLineItemAdjustments(data: UpsertLineItemAdjustmentDTO[], sharedContext?: Context): Promise<LineItemAdjustmentDTO[]>;
    /**
     ...
     *
     */
    upsertShippingMethodAdjustments(data: (CreateShippingMethodAdjustmentDTO | UpdateShippingMethodAdjustmentDTO)[], sharedContext?: Context): Promise<ShippingMethodAdjustmentDTO[]>;
    /**
     ...
     *
     */
    upsertLineItemTaxLines(taxLines: (CreateLineItemTaxLineDTO | UpdateLineItemTaxLineDTO)[], sharedContext?: Context): Promise<LineItemTaxLineDTO[]>;
    /**
     ...
     *
     */
    upsertShippingMethodTaxLines(taxLines: (CreateShippingMethodTaxLineDTO | UpdateShippingMethodTaxLineDTO)[], sharedContext?: Context): Promise<ShippingMethodTaxLineDTO[]>;
}
